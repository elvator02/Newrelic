...
const NewRelicTab = () => {
  ...
  const [selectedStage1, setSelectedStage1] =
    useState<any | null>(null);

  const [selectedStage2, setSelectedStage2] =
    useState<any | null>(null);
